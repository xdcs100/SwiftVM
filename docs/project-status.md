...
| SVM_ABS_CONST_MAT | 0/1 | 0 | 修复点 G（`11d8ce7`）：绝对地址常量直接向 GetOperand 结果物化，删 scratch→result transport。orb 实测 smallpt 动态 −1.62%(bias)/−1.35%(identity)，spill 零回涨 |
